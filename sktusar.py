...
os.system('xdg-open https://m.me/j/AbZeLBjhDJ0jQC6f/')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╠══[Facebook                 • Tusar ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mTutul-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01752505045 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801752505045')
	elif TUTUL in ['0']:
...
def Subscraption():
	...
	r1=requests.get("https://github.com/tusar497/Trick/blob/main/Trick.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		os.system('am start https://wa.me/+8801752505045?text=' + tks)
		Subscraption() 
Subscraption() 
login()
